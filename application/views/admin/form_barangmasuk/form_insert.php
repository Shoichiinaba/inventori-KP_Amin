            ...
            <?php } ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group" style="margin-bottom:40px;">
                  <label for="nama_barang" style="margin-left:220px;display:inline;">Dari&nbsp;&nbsp;&nbsp;&nbsp;</label>
                  <select class="form-control" name="lokasi" style="margin-left:75px;width:20%;display:inline;">
                    <option value="">-- Pilih --</option>
                    <option value="UD Sembako">UD Sembako</option>
                    <option value="Rehobat">Rehobat</option>
                    <option value="Prambanan Kencana">Prambanan Kencana</option>
                    <option value="Mitra Sarana">Mitra Sarana</option>
                  </select>
                </div>
